...
export default function Navbar() {
  return (
    <div className="bg-purple-500 shadow-md">
      <div className="flex bg-purple-600 shadow-md py-3 sm:px-6 px-4 min-h-[75px] tracking-wide relative z-50">
        <div className="flex max-w-screen-xl mx-auto w-full">
          <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full ">
            <Link href="javascript:void(0)" className="max-sm:hidden">
              <div>
                <h1 className="lilita text-5xl text-white drop-shadow-lg">
                  Purrfect Fit
                </h1>
              ...
              <div className="flex items-center sm:space-x-8 space-x-6">
                <div className="flex flex-col items-center justify-center gap-0.5 cursor-pointer">
                  <div className="relative">
                    <Heart className="cursor-pointer fill-[#333] inline w-5 h-5" />
                    {/* <svg
                    xmlns="http://www.w3.org/2000/svg"
