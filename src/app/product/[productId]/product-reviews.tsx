  ...
  <div className="max-w-4xl mx-auto">
    ...
    <div className="divide-y divide-gray-300">
      <div className="py-6">
        <div className="flex items-center gap-4">
          <div className="shrink-0">
            <img src="https://readymadeui.com/team-2.webp" className="object-cover rounded-full w-12 h-12 border-2 border-gray-400" alt="customer-img-1" />
          </div>
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="w-4 h-4 flex items-center justify-center rounded-full bg-green-600/20">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-2 h-2 fill-green-700" viewBox="0 0 24 24">
      ...
      <div className="py-6">
        <div className="flex items-center gap-4">
          <div className="shrink-0">
            <img src="https://readymadeui.com/team-3.webp" className="object-cover rounded-full w-12 h-12 border-2 border-gray-400" alt="customer-img-2" />
          </div>
          <div>
            <p className="text-[15px] text-slate-900 font-semibold">
              Daniel Kim
      ...
      <div className="py-6">
        <div className="flex items-center gap-4">
          <div className="shrink-0">
            <img src="https://readymadeui.com/team-4.webp" className="object-cover rounded-full w-12 h-12 border-2 border-gray-400" alt="customer-img-3" />
          </div>
          <div>
            <p className="text-[15px] text-slate-900 font-semibold">
              Priya Singh
      ...
      <div className="py-6">
        <div className="flex items-center gap-4">
          <div className="shrink-0">
            <img src="https://readymadeui.com/team-5.webp" className="object-cover rounded-full w-12 h-12 border-2 border-gray-400" alt="customer-img-4" />
          </div>
          <div>
            <p className="text-[15px] text-slate-900 font-semibold">
              Liam Brown
