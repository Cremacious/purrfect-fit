...
export default function ProductGrid({ animal }: { animal?: string }) {
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 max-xl:gap-4 gap-6 mb-4">
          <div className="bg-white shadow-sm border border-gray-200 rounded-lg p-3">
            ...
            <div className="flex flex-row items-center gap-2 mt-6  w-full">
              ...
              >
                <Link href={`/product/44`}>View</Link>
              </Button>
            </div>
          </div>
          <div className="bg-white shadow-sm border border-gray-200 rounded-lg p-3">
            ...
            <div className="flex items-center gap-2 mt-6">
              <div
                className="bg-pink-200 hover:bg-pink-300 w-12 h-9 flex items-center justify-center rounded-lg cursor-pointer"
                title="Wishlist"
              >
                <svg
              ...
              <button
                type="button"
                className="text-sm px-2 py-2 font-medium cursor-pointer w-full bg-indigo-600 hover:bg-indigo-700 text-white tracking-wide ml-auto outline-none border-none rounded-lg"
              >
                Add to cart
              </button>
            </div>
